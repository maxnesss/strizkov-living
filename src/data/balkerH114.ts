export const balkerH114 = {
  sourceUrl: "https://balker.pl/model-domu-balker-h114-standard/",
  ...
  stats: [
    ...
    { value: "20,5 x 18,1 m", label: "minimální doporučený rozměr pozemku" },
    { value: "1 podlaží", label: "přízemní dispozice s přímým výstupem na terasu" },
  ],
  highlights: [
    "přízemní dispozice pro současnou rodinu 2+2",
    "velký obývací prostor s jídelnou a kuchyní",
    "hlavní ložnice s vlastní šatnou a koupelnou",
    "velká prosklení pro více denního světla",
    "prefabrikovaná modulární výstavba",
    "možnost variant Modern White nebo Modern Black",
  ],
  storySections: [
    {
  ...
  roomSchedule: [
    { symbol: "1/01", room: "Zádveří", floorArea: "5,96 m2", usableArea: "5,96 m2" },
    { symbol: "1/02", room: "Pokoj", floorArea: "11,01 m2", usableArea: "11,01 m2" },
    { symbol: "1/03", room: "Pokoj", floorArea: "12,25 m2", usableArea: "12,25 m2" },
    { symbol: "1/04", room: "Hala", floorArea: "10,96 m2", usableArea: "10,96 m2" },
    { symbol: "1/05", room: "Šatna", floorArea: "3,50 m2", usableArea: "3,50 m2" },
    { symbol: "1/06", room: "Ložnice", floorArea: "15,43 m2", usableArea: "15,43 m2" },
    { symbol: "1/07", room: "Koupelna", floorArea: "4,06 m2", usableArea: "4,06 m2" },
    {
      symbol: "1/08",
      room: "Obývací pokoj s jídelnou",
      floorArea: "26,90 m2",
      usableArea: "26,90 m2",
    },
    { symbol: "1/09", room: "Kuchyně", floorArea: "12,25 m2", usableArea: "12,25 m2" },
    { symbol: "1/10", room: "Koupelna", floorArea: "4,09 m2", usableArea: "4,09 m2" },
    { symbol: "1/11", room: "Kotelna", floorArea: "7,45 m2", usableArea: "7,45 m2" },
  ],
  totals: {
    livingPart: "106,41 m2",
    utilityPart: "7,45 m2",
    total: "113,86 m2",
  },
  construction: [
    {
      ...
      layers: [
        ...
        "konstrukční hranol 50 x 160 mm",
        "minerální vlna Rockwool 15 cm ve konstrukci",
        "chránička pro elektroinstalaci",
        "OSB nebo MFP deska 1,2 cm",
        "parozábrana",
    ...
    },
    {
      ...
      layers: [
        ...
        "lať",
        "kontralať",
        "plechová krytina na stojatou drážku",
      ],
    },
  ],
  gallery: [
